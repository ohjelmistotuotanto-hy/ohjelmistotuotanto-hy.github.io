...
Ensimmäinen stroty 4 pistettä:
- Ei asiakkaan kielellä 0.75 pistettä per puute/korjaus
- Liian iso 0.75 pistettä per puute/korjaus
- Valmius vaikea arvioida  0.25 pistettä per puute/korjaus
- Hyväksymäkriteerien puute 0.25 pistettä per puute/korjaus
