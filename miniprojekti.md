...
* Kun tulet aloitustilaisuuteen, sinun on syytä tuntea viikkojen 1-2 luennoilla käsitellyt asiat: 
  * scrum
  * sprintti
  * user story
  * product backlog
  ...
  * hyväksymäkriteeri
  * definition of done
* Tämä dokumentti on myös syytä lukea huolellisesti ennen aloitustilaisuutta
...
* Ryhmän tulee varata aika sprinttien 2-4 asiakastapaamisille
...
* selviää ensimmäisessä aloitustilaisuudessa

### Tekniset ja prosessiin liittyvät vaatimukset

> Huomaa: Vaatimukset &#x2248; oppimistavoitteet
...
* Sprintin suunnittelun yhteydessä ryhmä sitoutuu toteuttamaan sopivan määrän Backlogin kärjessä olevista User storyistä
  ...
  * Ryhmä sitoutuu ainoastaan niihin User storyihin, jotka se kuvittelee kykenevänsä toteuttamaan sprintissä **Definition of Donen** määrittelemällä laatutasolla. Definition of done on määritelty alla
  ...
  * Asiakkaalle ei kannata luvata liikaa, ja varsinkin ensimmäisten sprinttien aikana arvioissa on otava varovaisempi, konfiguroimiseen ja testaamiseen tulee kulumaan paljon aikaa
...
* User storyille tulee määritellä hyväksymäkriteerit, jotka dokumentoidaan [Cucumberin](/cucumber/) featureiksi
  * hyvänä käytänteenä on laittaa README:stä linkki hyväksymäkriteerit määritteleviin tiedostoihin
* Toteututun koodin testikattavuus tulee olla vähintään 80% (rivikattavuus)
...
- Kokonaan uusien teknologioiden opettelu miniprojektin yhteydessä ei ole välttämättä järkevää
...
- JavaFX:llä tehtyjen sovellusten automatisoitu testaaminen on mahdollista [TestFX](https://github.com/TestFX/TestFX)-kirjaston avulla. Kirjaston dokumentaatio ei ole parhaasta päästä
  - yksinkertainen gradle+javaFX+cucumber+travis esimerkkikonfiguraatio osoitteessa https://github.com/mluukkai/fx-testing
- Java Swing-sovellusten cucumberilla tapahtuva käyttöliittymätason testaus on tässä vaiheessa vielä mysteeri
- **DANGER** edellisinä vuosina on huomattu, että Java Springin konfigurointi (toimimaan yhdessä gradlen, cucumberin ja Travisin kanssa) miniprojektille varatun ajan puitteissa on osoittautunut haastavaksi. Käyttäkää siis springiä omalla vastuulla
  - yksinkertainen gradle+spring+cucumber+travis esimerkkikonfiguraatio osoitteessa https://github.com/mluukkai/spring-cucumber
